...
var (
	...
	DuplicateTagError         = add(20000300) // 重复标签, 标签错误 20000300 - 20000399
	DuplicateTagGroupError    = add(20000301) // 重复标签组
	UnsupportedMsgError       = add(20000400) // 不支持的消息类型, 群消息错误 20000400 - 20000499
	EarlierThanNowError       = add(20000401) // 不支持的消息类型, 群消息错误 20000400 - 20000499
	TimedMsgUnchangeableError = add(20000402)
	UnsupportedFileTypeError  = add(20000403) // 不支持的上传文件类型
