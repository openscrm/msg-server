...
func JsonEncode(data interface{}) string {
	...
	if err != nil {
		log.Sugar.Errorw("JsonEncode failed", "err", err, "data", data)
		return ""
	}
	return jsonStr
}
...
func FuncTracer(params ...interface{}) func(...interface{}) {
	...
	log.Sugar.Infow(funName+" start", params...)
	start := time.Now()
	...
	return func(results ...interface{}) {
		...
		if logLevel == zap.ErrorLevel {
			log.Sugar.Errorw(funName+" done", results...)
		} else {
			log.Sugar.Infow(funName+" done", results...)
		}
	}
}
