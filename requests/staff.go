...
type QueryStaffReq struct {
	// 企业微信部门id, 0-所有部门, 非0-制定部门
	ExtDepartmentID int64 `json:"ext_department_id" form:"ext_department_id" validate:"omitempty,gte=0"`
	// 员工名字
...
type UpdateCustomerTagsReq struct {
	...
	AddExtTagIDs    []string `json:"add_ext_tag_ids" form:"add_ext_tag_ids" validate:"omitempty,gt=0"`
