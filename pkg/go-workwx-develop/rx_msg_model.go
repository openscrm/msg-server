...
// ChangeTypeCreateUser
const ChangeTypeCreateUser ChangeType = "create_uesr"

// ChangeTypeCreateUser
const ChangeTypeDelUser ChangeType = "delete_uesr"
...
// ChangeTypeCreateTag 更新标签事件
const ChangeTypeUpdateTag ChangeType = "update"

// ChangeTypeCreateTag 删除标签事件
...
// ChangeTypeDissmissChat 客户群解散事件
const ChangeTypeDissmissChat ChangeType = "dismiss"

// 添加外部联系人同意进行聊天内容存档时，回调该事件。
...
type rxEventCreateParty struct {
	...
	ParentId int64  `xml:"parent_id"` // 父部门id
