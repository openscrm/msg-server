...
const (
	CustomerEventRemainder         = "reminder_event"
	CustomerEventCustomerAction    = "customer_action"
	CustomerEventManualEvent       = "manual_event"
	CustomerEventMomentInteraction = "moment_interaction"
	CustomerEventTemplateEvent     = "template_event"
	CustomerEventUpdateRemark      = "update_remark"
	CustomerEventClueManualEvent   = "clue_manual_event"
)

// RemainderContent 提醒类型事件的内容
const (
	RemainderContent = `[ %s ], 您收到一条关于客户[ %s ]的提醒事件。 提醒内容: [ %s ] `
)

// EventName
// EventType 中 constomer_action 中 细分类别
const (
	EventNameAutoMerge             = "AutoMerge"
